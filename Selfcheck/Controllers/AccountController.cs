...
namespace SampleSite.Controllers
{
    public class AccountController : Controller
    {
        ...
        public UserManager<SampleUser> UserManager;
        public SignInManager<SampleUser> SignInManager;

        public IMongoCollection<SampleUser> UserCollection;
        ...
        {
            var user = new SampleUser { UserName = model.Username, Email = model.Email };
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new SampleUser { UserName = model.Email, Email = model.Email };
